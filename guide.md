...
![Windows Store](https://github.com/TheShepord/WSL-guide/blob/master/docs/images/winstore.png)
...
![vim /etc/passwd](https://github.com/TheShepord/WSL-guide/blob/master/docs/images/vim-etc-passwd.png)
